...
describe("Triangle", () => {
  it("should render a blue triangle in svg", () => {
    ...
    width="300" height="200"
    xmlns="http://www.w3.org/2000/svg"><triangle points="150, 18 244, 182 56, 182" fill="blue" /><text x="50%" y="50%" text-anchor="middle" fill="green">WOW</text></svg>`);
  });
});
...
describe("Square", () => {
  it("should render a yellow square in svg", () => {
    ...
    width="300" height="200"
    xmlns="http://www.w3.org/2000/svg"><square x="90" y="40" width="120" height="120" fill="yellow" /><text x="50%" y="50%" text-anchor="middle" fill="blue">HAH</text></svg>`);
  });
});
